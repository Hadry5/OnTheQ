    ...
    <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="table-responsive w-75 mt-5">
                    ...
                    <table class="table table-stripped">
                        ...
                        <tbody>
                            <?php
                            $sql5 = "SELECT `TypeID`, `Name`, `WorkspaceID`, `Price`, `Description` FROM room";
        ...
        <script>
            ...
            function deleteBooking(bookid) {
                ...
                xmlhttp.open("GET", "deletedesk.php?TypeID=" + bookid + "&Type=room", true);
                xmlhttp.send();
            }
        </script>
        <!-- Optional JavaScript -->
