    ...
    <div class="row">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="table-responsive w-75 mt-5">
                    <p class="fs-3 mb-4">All Workspace</p>
                    <table class="table table-stripped">
                        ...
                        <tbody>
                            <?php
                            $sql5 = "SELECT `TypeID`, `Name`, `Price`, `Description` FROM workspace";
        ...
        <script>
            ...
            function deleteBooking(bookid) {
                ...
                xmlhttp.open("GET", "deletedesk.php?TypeID=" + bookid + "&Type=workspace", true);
                xmlhttp.send();
            }
        </script>
        <!-- Optional JavaScript -->
